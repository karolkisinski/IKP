    ...
    <jet-form-section @submitted="updateProfileInformation">
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <jet-input id="username" type="text" class="mt-1 block w-full text-gray-300" v-model="form.username" disabled="true"/>
            </div>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <select v-model="form.gender" class="block mt-1 w-full border-gray-300 focus:
                border-indigo-300 focus:rig-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
